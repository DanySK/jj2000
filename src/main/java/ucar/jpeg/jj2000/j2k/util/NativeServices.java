...
public final class NativeServices {
     ...
     * native methods: 'ucar.jpeg.jj2000'. The actual file name of the library is system
     * dependent. Under UNIX it will be 'libjj2000.so', while under Windows it 
     * will be 'ucar.jpeg.jj2000.dll'.
     * */
    public static final String SHLIB_NAME = "ucar/jpeg/jj2000";
